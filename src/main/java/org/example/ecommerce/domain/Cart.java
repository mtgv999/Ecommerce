...
public class Cart extends BaseEntity{@Id//장바구니
    ...
    @NotNull(message = "장바구니 이름은 꼭 작성 해야 됨.")
    @Size(min=1,max=30, message = "장바구니 이름: 최소 1자, 최대 30자")
    ...
    @NotNull(message = "총 상품 개수 값은 꼭 작성 해야 됨")
    @Min(value=1, message = "총 상품 개수 값은 최소 1이어야 됨.")
    @Max(value = 999999, message = "총 상품 개수 값은 최대 999,999이어야 됨.")
    private Long cartStock;//장바구니 내 상품들의 총 개수

    @NotNull(message = "가격 총합 값은 작성 해야 됨.")
    @Min(value=1, message = "가격 총합 값은 최소 1이어야 됨.")
    @Max(value = 999999999,
            message = "가격 총합 값은 최대 999,999,999이어야 됨.")
